...
# Page configuration
st.set_page_config(
    page_title="KAYA - Premium Pregnancy Assistant",
    page_icon="👶",
    layout="wide",
...
def main():
    ...
    with st.sidebar:
        ...
        st.image("https://raw.githubusercontent.com/devtayyabsajjad/My_Baby/main/images/MY%20BABY.png", caption="KAYA")
        st.markdown("---")
    ...
    if selected == "Home":
        ...
        # st.markdown("---")
        st.markdown(
            "<div style='text-align: center'>© 2024 KAYA. All rights reserved.</div>", 
